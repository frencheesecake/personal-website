...
const Socials = () => {
  return (
    <div class="col-start-2 col-span-10 mt-auto lg:mt-0 lg:col-start-11 lg:col-span-1">
      <p class="text-center lg:text-end mb-4">Creep me at:</p>
      <div class="solcials flex lg:flex-col justify-between">
